...
csv_path = OUT / "var_horserace_results_reer_yoy.csv"
...
for f in ["relrmse_heatmap.png", "winner_forecasts.png"]:
    (OUT / f.replace(".png", "_reer_yoy.png")).write_bytes((FIG / f).read_bytes())
print(f"[saved] {OUT/'relrmse_heatmap_reer_yoy.png'}\n[saved] {OUT/'winner_forecasts_reer_yoy.png'}")
...
(OUT / "var_horserace_summary_reer_yoy.json").write_text(json.dumps(summary, indent=2))
print(f"[saved] {OUT/'var_horserace_summary_reer_yoy.json'}")
print("\nDONE.")
